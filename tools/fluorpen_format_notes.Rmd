...
Biolyzer remains the primary validation reference for the package. The FluorPen
files are useful as an additional vendor-export comparison source.
...
Because of this, the FluorPen reader includes cautious normalization heuristics
for selected vendor summary fields such as:
...
These heuristics are only used to interpret the vendor footer for validation.
They do not affect the core `fluorojip` formulas.
